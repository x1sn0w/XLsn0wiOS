...
@property (nonatomic, assign) CGFloat nullImageViewTop;
@property (nonatomic, assign) CGFloat nullImageViewWidth;
@property (nonatomic, assign) CGFloat nullImageViewHeight;

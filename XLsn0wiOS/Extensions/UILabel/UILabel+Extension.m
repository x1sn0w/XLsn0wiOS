...
//    NSRange boldedRange = NSMakeRange(7, 5);
    ...
    [attributedText addAttribute:NSFontAttributeName
                           ...
                           range:boldRange];
    // 改变字体颜色
    [attributedText addAttribute:NSForegroundColorAttributeName value:titleColor range:NSMakeRange(0, text.length)];
  
    [attributedText addAttribute:NSParagraphStyleAttributeName value:paraStyle range:NSMakeRange(0, text.length)];

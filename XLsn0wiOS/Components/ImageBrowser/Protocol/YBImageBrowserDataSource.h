...
/**
 ...
 @return 数量
 */
- (NSInteger)yb_numberOfCellsInImageBrowser:(ImageBrowser *)imageBrowser;
...
/**
 ...
 @return 数据
 */
- (id<YBIBDataProtocol>)yb_imageBrowser:(ImageBrowser *)imageBrowser dataForCellAtIndex:(NSInteger)index;

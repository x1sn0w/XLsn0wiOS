...
@implementation NetworkPermission
...
+ (NetworkPermission *)sharedInstance {
    static NetworkPermission * instance = nil;
...
static void ReachabilityCallback(SCNetworkReachabilityRef target, SCNetworkReachabilityFlags flags, void* info) {
    NetworkPermission *networkAccessibity = (__bridge NetworkPermission *)info;
    if (![networkAccessibity isKindOfClass: [NetworkPermission class]]) {
        return;
    }

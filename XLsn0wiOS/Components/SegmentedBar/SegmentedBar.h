...
@protocol SegmentedBarDelegate <NSObject>
...
@property (nonatomic, weak) id<SegmentedBarDelegate>delegate;
 ...
 */
- (instancetype)initWithFrame:(CGRect)frame titles:(NSArray *)titlesArr delegate:(id<SegmentedBarDelegate>)delegate indicatorType:(SegmentedBarIndicatorType)incatorType;

...
-(void)pushAnimateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    UIViewController<ViewControllerTransitionProtocol> * fromVC = (UIViewController <ViewControllerTransitionProtocol> * )[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    UIViewController<ViewControllerTransitionProtocol> * toVC = (UIViewController <ViewControllerTransitionProtocol> * )[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    //from和to的两个视图
    ...
    [UIView animateWithDuration:self.animationDuration animations:^{
        ...
        appDelegate.tabBarController.tabBar.alpha = 0;
...
- (void)popAnimateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    [UIView animateWithDuration:self.animationDuration animations:^{
        ...
        appdelegate.tabBarController.tabBar.alpha = 1;
    } completion:^(BOOL finished) {

...
@interface XLsn0wScrollBar () <UICollectionViewDelegateFlowLayout, UICollectionViewDataSource>
...
@implementation XLsn0wScrollBar
...
-(void)setSelected:(BOOL)selected {
    ...
    if (selected) {
        ...
        _titleLabel.textColor = _selectedColor;
         [_titleLabel xlsn0w_layerBorderWidth:1 borderColor:[UIColor xlsn0w_hexString:@"#57A1FF"] cornerRadius:15];
    }else{
        _titleLabel.font = _normalFont;
        _titleLabel.textColor = _normalColor;
         [_titleLabel xlsn0w_layerBorderWidth:0 borderColor:UIColor.clearColor cornerRadius:0];
    }
}

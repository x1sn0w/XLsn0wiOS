...
typedef void(^XLsn0wScrollBarAction)(NSUInteger selectedIndex);

@interface XLsn0wScrollBar : UIView

@property (nonatomic, copy) XLsn0wScrollBarAction scrollUnderlineButtonBlock;
